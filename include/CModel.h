...
// Forward declaration for legacy GetObjects() interface
class CObject;
...
public:
    ...
    void		RenderRaw(int lm=0) { renderRaw(); }
    CollisionModel3D *GetCDModel(void) { return getCDModel(); }
    ...
    // Legacy aliases used by RacingEngine and other older code
    CObject		*GetObjects(void);
    int			GetNumObjects(void) { return (int)m_nNumMeshes; }
};
