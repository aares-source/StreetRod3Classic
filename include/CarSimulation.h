...
// Forward declarations for stub methods
class CSimBody;
class CWheel;
...
// Legacy CCarSim-compatible interface - proxies into carsim_t data
// These allow code written against CCarSim to compile with carsim_t
inline CSimBody* carsim_getSimBody(carsim_t*) { return NULL; }
inline void* carsim_getWheel(carsim_t*, int) { return NULL; }
inline void* carsim_getContact(carsim_t*) { return NULL; }
